 ...
 */
@Entity
@Table(name = "bus_mall_product_group", catalog = "billionfun")
public class BusMallProductGroup implements java.io.Serializable {
	...
	/** full constructor */
	public BusMallProductGroup(Long id, String name, String description,
			Long categoryId, String userId, Date createDate, String status) {
		this.id = id;
		this.name = name;
