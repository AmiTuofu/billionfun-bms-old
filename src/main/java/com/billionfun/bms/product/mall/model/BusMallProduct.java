 ...
 */
@Entity
@Table(name = "bus_mall_product", catalog = "billionfun")
public class BusMallProduct implements java.io.Serializable {
	...
	/** full constructor */
	public BusMallProduct(String id, String name, String userId,
			Long productGroupId, Date createDate, Integer status) {
		this.id = id;
		this.name = name;
		this.userId = userId;
