...
public class BusMallOrder  implements java.io.Serializable {
    ...
    /** full constructor */
    public BusMallOrder(String id, String userId, Double totalPrice, Double freightPrice, String status, Long deliveryId, String paymentId) {
        this.id = id;
        this.userId = userId;
