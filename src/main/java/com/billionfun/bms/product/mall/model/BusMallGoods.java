...
public class BusMallGoods  implements java.io.Serializable {
    ...
    /** full constructor */
    public BusMallGoods(String id, String productId, Double price, Integer stock, String status, Timestamp createDate, String lastModifyDate, String userId) {
        this.id = id;
