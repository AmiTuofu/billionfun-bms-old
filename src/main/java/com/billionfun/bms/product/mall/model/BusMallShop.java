...
public class BusMallShop  implements java.io.Serializable {
    ...
    /** full constructor */
    public BusMallShop(String id, String name, String province, String city, String district, String realName, String mobile, String status, Date createDate, String userId) {
        this.id = id;
        this.name = name;
